...
class SdlRenderer {
public:
  SdlRenderer(std::string title, Size size, bool fullscreen, bool borderless, bool vsync, bool force_opengl);
  ~SdlRenderer();

  SdlRenderer(const SdlRenderer&) = delete;
  SdlRenderer& operator=(const SdlRenderer&) = delete;

  bool handle_events(bool& restart_requested, bool& audio_restart_requested, bool& mute_requested, float& volume_delta);
  ...
  [[nodiscard]] bool show_gui() const { return show_gui_; }
